...
<div class="container">
 ...
 <!-- 회원가입에 회원번호(?)  -->
	...
	<div>
  	<input type="text" placeholder="ID" class="normal" name="ID"><br>
    <input type="password" placeholder="Password" class="normal"><br>
    </div>
    
   <!-- <p class="normal light2">Register Privacy</p> -->
    <input type="text" placeholder="Name" class="normal name" name="Name"><br>
    <input type="text" placeholder="Phone number" class="normal name" name="Phonenumber"><br>    
   <input type="text" placeholder="Email" class="normal name" name="Email" style=" width: 40%; "> <select class="normal name" name='detailemail'>
